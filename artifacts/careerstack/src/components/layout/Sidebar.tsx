  ...
  return (
    <aside className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 border-r border-border bg-card/50 backdrop-blur-xl glass">
      <div className="flex flex-col h-full px-4 py-6">
        <Link href="/dashboard" className="flex items-center space-x-2 mb-10 px-2 cursor-pointer hover:opacity-90 transition-opacity">
          <img src="/logo.png" alt="MyProjectory Logo" className="w-8 h-auto rounded-md" />
          <span className="text-[1.35rem] font-bold tracking-tight text-[#021a69]" style={{ fontFamily: "'Arvo', serif" }}>myProjectory</span>
        </Link>
